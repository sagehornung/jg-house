...
class Nova_Field extends Nova_Customizer {
	...
	public function __construct( $args ) {
		...
		if ( $this->wp_customize ) {
			 ...
			 * Create the control
			 */
			new Nova_Control( $this->args );
			/**
			 * Create the scripts for postMessage to properly work
			 */
			Nova_Customizer_Scripts_PostMessage::generate_script( $this->args );
			/**
			 * Create the scripts for tooltips.
			 */
			Nova_Customizer_Scripts_Tooltips::generate_script( $this->args );
		}
	...
	public static function get_config_id( $field ) {
		...
		$config = 'global';
		/**
		 * Get the array of configs from the Nova class
		 */
		$configs = Nova::$config;
		/**
