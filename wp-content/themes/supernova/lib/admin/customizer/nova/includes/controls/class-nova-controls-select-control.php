...
if ( class_exists( 'Nova_Controls_Select_Control' ) ) {
	return;
}

class Nova_Controls_Select_Control extends Nova_Customize_Control {

	public $type = 'nova-select';
	...
	public function enqueue() {
		...
		Nova_Styles_Customizer::enqueue_customizer_control_script( 'nova-select', 'controls/select', array( 'jquery', 'selectize' ) );
	}
