 ...
 * for documentation see https://github.com/aristath/nova/wiki/required
 *
 * @package     Kirki
 * @category    Core
...
if ( class_exists( 'Nova_PostMessage' ) ) {
	return;
}

class Nova_Customizer_Scripts_PostMessage extends Nova_Customizer_Scripts {
	...
	public static function generate_script( $args = array() ) {
		...
		if ( isset( $args['js_vars'] ) && 'postMessage' == $args['transport'] ) {
			 ...
			 * can be found on https://github.com/aristath/nova/wiki/js_vars
			 */
