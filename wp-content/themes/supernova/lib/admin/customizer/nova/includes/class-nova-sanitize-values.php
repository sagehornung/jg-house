...
if ( class_exists( 'Nova_Sanitize_Values' ) ) {
	return;
}

class Nova_Sanitize_Values extends Nova_Sanitize {
	...
	public static function rgba( $value ) {
		...
		if ( false === strpos( $value, 'rgba' ) ) {
			return Nova_Color::get_rgba( Nova_Color::sanitize_hex( $value ) );
		}
	...
	public static function color( $value ) {
		...
		if ( 'rgba' == $mode ) {
			return Nova_Color::sanitize_hex( $value );
		} else {
