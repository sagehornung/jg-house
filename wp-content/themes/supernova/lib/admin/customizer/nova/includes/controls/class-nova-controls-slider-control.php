...
if ( class_exists( 'Nova_Controls_Slider_Control' ) ) {
	return;
}

class Nova_Controls_Slider_Control extends Nova_Customize_Control {
	...
	protected function content_template() { ?>
		...
		<label>
			...
			<div class="wrapper">
				...
				<div class="nova_range_value">
					<span class="value">{{ data.value }}</span>
					<# if ( data.choices['suffix'] ) { #>
						{{ data.choices['suffix'] }}
					<# } #>
				</div>
				<div class="nova-slider-reset">
