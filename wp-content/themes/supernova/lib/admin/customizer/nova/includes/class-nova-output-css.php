...
if ( class_exists( 'Nova_Output_CSS' ) ) {
	return;
}

class Nova_Output_CSS {
	...
	public static function css( $field ) {
		 ...
		 */
		$field_sanitized = Nova_Field_Sanitize::sanitize_field( $field );
		/**
		 * Set class vars
		 */
		 ...
		 */
		self::$value = Nova_Values::get_sanitized_field_value( $field_sanitized );
		/**
		 * Returns the styles
		 */
		return self::styles();
