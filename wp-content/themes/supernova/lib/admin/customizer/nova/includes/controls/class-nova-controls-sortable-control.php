...
if ( class_exists( 'Nova_Controls_Sortable_Control' ) ) {
	return;
}

class Nova_Controls_Sortable_Control extends Nova_Customize_Control {
			...
			<ul class="sortable">
				<# for ( i in data.filteredValues ) { #>
					<# if ( data.filteredValues.hasOwnProperty( i ) ) { #>
						<li class='nova-sortable-item' data-value='{{ data.filteredValues[i] }}'>
				...
				<# for ( i in data.invisibleKeys ) { #>
					<# if ( data.invisibleKeys.hasOwnProperty( i ) ) { #>
						<li class='nova-sortable-item invisible' data-value='{{ data.invisibleKeys[i] }}'>
							<i class='dashicons dashicons-menu'></i>
							<i class="dashicons dashicons-visibility visibility"></i>
