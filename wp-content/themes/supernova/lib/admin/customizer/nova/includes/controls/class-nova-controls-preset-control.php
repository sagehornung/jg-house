...
if ( class_exists( 'Nova_Controls_Preset_Control' ) ) {
	return;
}

class Nova_Controls_Preset_Control extends Nova_Customize_Control {
	...
	public function enqueue() {
		...
		Nova_Styles_Customizer::enqueue_customizer_control_script( 'nova-preset', 'controls/select', array( 'jquery', 'selectize' ) );
	}
