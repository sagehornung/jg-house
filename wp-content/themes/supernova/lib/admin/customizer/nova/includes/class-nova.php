 ...
 * For documentation please see https://github.com/aristath/nova/wiki
 *
 * @package     Kirki
 * @category    Core
...
class Nova extends Nova_Init {
	...
	public static function get_option( $config_id = '', $field_id = '' ) {
		return Nova_Values::get_value( $config_id, $field_id );
	}
	...
	public static function add_config( $config_id, $args = array() ) {
		new Nova_Config( $config_id, $args );
	}
	...
	public static function add_panel( $id = '', $args = array() ) {
		...
		if ( ! isset( $args['active_callback'] ) ) {
			$args['active_callback'] = ( isset( $args['required'] ) ) ? array( 'Nova_Active_Callback', 'evaluate' ) : '__return_true';
		}
	...
	public static function add_field( $config_id, $args ) {
		Nova_Field::add_field( $config_id, $args );
	}
	...
	public static function get_config_id( $field ) {
		return Nova_Field::get_config_id( $field );
	}
