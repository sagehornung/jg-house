...
if ( class_exists( 'Nova_Controls_Typography_Control' ) ) {
	return;
}

class Nova_Controls_Typography_Control extends Nova_Customize_Control {
	...
	public function get_standard_fonts() {
		return Nova()->font_registry->get_standard_fonts();
	}

	public function get_google_fonts() {
		return Nova()->font_registry->get_google_fonts();
	}
